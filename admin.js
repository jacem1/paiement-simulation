...
function calculateMetrics(transactions) {
    ...
    // Time calculations
    const networkTimes = filteredTransactions.map(t => t.networkTime || 0);
    const totalTimes = filteredTransactions.map(t => t.totalTime || 0);
        ...
        row.innerHTML = `
            ...
            <div class="timing-details">
                <div class="timing-detail">
                    ...
                    <div class="timing-detail-value">${formatDuration(transaction.networkTime || 0)}</div>
                </div>
                <div class="timing-detail">
                ...
                <div class="timing-detail">
                    ...
                    <div class="timing-detail-value">${formatDuration(transaction.totalTime || 0)}</div>
                </div>
            </div>
        `;
